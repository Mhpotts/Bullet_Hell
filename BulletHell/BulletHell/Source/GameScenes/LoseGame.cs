...
{
    public class LoseGame : Scene
    {

        public LoseGame(MainGame game, GraphicsDevice graphicsDevice, ContentManager manager) :
            base(game, graphicsDevice, manager)
        {
            texture = manager.Load<Texture2D>("lose_background");
